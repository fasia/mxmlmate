...
\subsection{Results}
In this section the results of the empirical evaluation are presented. \Cref{tbl:fitness} shows an overview of
...
% TODO consider rearranging table rows
\begin{table}[H]
\small
\centering
...
\multicolumn{1}{|c|}{Subject}  & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Schema\\ Valid\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}BBL\\ Coverage\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}BBL\\ Succession\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Memory\\ Access\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}$\downarrow$ Division\\ by 0\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Integer\\ Overflow\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Buffer\\ Overflow\end{tabular}} \\ \hline \hline
                               & +                                                                           &     ?                                                                       &         ?                                                                     &             ?                                                                &                     1                                                      & 4.61146E18                                                                      & 2102329                                                                        \\ \cline{2-8} 
...
In accordance with their respective descriptions in \cref{sec:fit}, all fitness functions presented in
...
% TODO Explanation for best score 1.0: it's int and on 0 we already crash
...
\Cref{tbl:png:vulns} shows a selection of vulnerabilities in \libpng alongside versions affected by
them.
...
\centering
\begin{tabular}{|r|r|l|}
\hline % TODO add CVE score
Vulnerability   & Version 	 	 & Short Description \\ \hline \hline 
CVE-2013-6954   & 1.6.6          & Null pointer dereference on empty palette \\ \hline % test with buf(10/157), bbl2, mem
CVE-2011-3328   & 1.5.4 		 & Arithmetic exception: division by zero   \\ \hline  % tested with div0(10/132)
CVE-2011-3048   & 1.5.9			 & Unchecked failing malloc in constrained memory \\ \hline % test with mem(127/3449), buf
% TODO write about restricting memory to 450 MB
CVE-2011-2691   & 1.5.2			 & Null pointer dereference in error message \\ \hline % test with buf(36/5k), mem
CVE-2008-1382   & 1.2.25 		 & Segmentation fault on size 0 unknown chunks \\ \hline % test with bbl2(10/0),
% schemaCov TODO remember to change schema - allow unknown chunks
\end{tabular}
...
% ??? make this an extra subsubsection?
