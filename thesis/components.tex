...
format converters and \texttt{m} \emph{workers} % TODO introduce earlier (maybe in intro with picture)
(a collective noun summarizing a test driver, its pintool, the program under test, and their lifeguard
instance).
% TODO move the following to legend 
...
without having to keep the entire system in the focus of attention. % XXX rephrase? 
