...
\node[above =1.5cm of inspcap]{XML Instance};
\end{scope}
%
...
\draw[blue,dotted,thick,->] (insheader)..controls +(north west:4) and +(south west:4)..(header);
...
\draw[orange,dashdotted,thick,->] (decl1)..controls +(north:3.5) and +(south:2.5)..(inspcap)
\draw[orange,dashdotted,thick,->] (decl2)..controls +(north:3.5) and +(south:2.5)..(insheader);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1) and +(east:5)..(insnetwork);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1) and +(east:4.5)..(inssnaplen);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1) and +(east:4)..(inssigfigs);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1) and +(east:3.5)..(insthiszone);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1) and +(east:3)..(insvmi);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1) and +(east:2.5)..(insvma);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:1.5) and +(west:2)..(insvmival);
\draw[orange,dashdotted,thick,->] (decl3)..controls +(north:2) and +(west:1.5)..(insvmaval);
\draw[orange,dashdotted,thick,->] (decl4)..controls +(north:3.5) and +(south west:1.5)..(insnetworkval);
\draw[orange,dashdotted,thick,->] (decl4)..controls +(north:2) and +(south west:1)..(inssnaplenval);
\end{tikzpicture}
