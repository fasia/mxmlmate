...
Fortunately, it is possible to use another artifact of \evosuite's to provide deviations from the 
...
yet have better fitness. One implementation of this is interval bounded numeric offset mutation - 
