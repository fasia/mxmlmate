			...
			if (node instanceof MethodInsnNode) {
				...
				if (methodNode.owner.equals("java/util/Collection")
					...
					if (methodNode.name.equals("isEmpty")) {
                        ...
                        logger.debug("Test Transformation of {}.{} -> {}.collectionIsEmpty", methodNode.owner, methodNode.name, Type.getInternalName(BooleanHelper.class));
                        ...
                        logger.debug("Test Transformation of {}.{} -> {}.collectionContains", methodNode.owner, methodNode.name, Type.getInternalName(BooleanHelper.class));
                        ...
                        logger.debug("Test Transformation of {}.{} -> {}.collectionContainsAll", methodNode.owner, methodNode.name, Type.getInternalName(BooleanHelper.class));
					...
					if (methodNode.name.equals("isEmpty")) {
                        ...
                        logger.debug("Test Transformation of {}.{} -> {}.mapIsEmpty", methodNode.owner, methodNode.name, Type.getInternalName(BooleanHelper.class));
                        ...
                        logger.debug("Test Transformation of {}.{} -> {}.mapContainsKey", methodNode.owner, methodNode.name, Type.getInternalName(BooleanHelper.class));
                        ...
                        logger.debug("Test Transformation of {}.{} -> {}.mapContainsValue", methodNode.owner, methodNode.name, Type.getInternalName(BooleanHelper.class));
