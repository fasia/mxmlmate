...
public class JUnitRunListener extends RunListener {
	...
	private final static Logger logger = LoggerFactory.getLogger(JUnitRunListener.class);
	...
	public void testStarted(Description description) {
        logger.debug("* Started: ClassName: {}, MethodName: {}", description.getClassName(), description.getMethodName());
	...
	public void testFinished(Description description) {
        logger.debug("* Finished: ClassName: {}, MethodName: {}", description.getClassName(), description.getMethodName());
