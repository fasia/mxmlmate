			...
			for (Constraint<?> c : constraints) {
				...
				if (c instanceof StringConstraint) {
					...
					try {
                        ...
                        log.debug("S: {} strDist {}", string_constraint, strD);
					} catch (Throwable t) {
                        log.debug("S: {} strDist {}", string_constraint, t);
						result += 1.0;
					}
                    ...
                    log.debug("C: {} intDist {}", integer_constraint, intD);
                    ...
                    log.debug("C: {} realDist {}", real_constraint, realD);
