	...
	public static boolean validateRuntimeVariables(Map<String,OutputVariable<?>> map){
		...
		try{
			...
			if(coveredBranches!=null && totalBranches!=null && coveredBranches > totalBranches){
                logger.error("Obtained invalid branch count: covered {} out of {}", coveredBranches, totalBranches);
				valid = false;
			}
			...
			if(coveredGoals!=null && totalGoals!=null && coveredGoals > totalGoals){
                logger.error("Obtained invalid goal count: covered {} out of {}", coveredGoals, totalGoals);
				valid = false;
			}
			...
			if(coveredMethods!=null && totalMethods!=null && coveredMethods > totalMethods){
                logger.error("Obtained invalid method count: covered {} out of {}", coveredMethods, totalMethods);
				valid = false;
			}
