...
public class BytecodeInstructionPool {
	...
	public BytecodeInstruction getInstruction(String className, String methodName,
        ...
        logger.debug("unknown instruction {}, have {}", instructionId, instructionMap.get(className).get(methodName).size());
	...
	public BytecodeInstruction getInstruction(String className, String methodName,
        ...
        logger.debug("unknown instruction: {}, have {} instructions for this method", node, instructionMap.get(className).get(methodName).size());
