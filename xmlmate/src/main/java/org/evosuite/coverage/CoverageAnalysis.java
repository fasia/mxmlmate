...
public class CoverageAnalysis {
	...
	public static void analyzeCriteria(TestSuiteChromosome testSuite, String criteria) {
        ...
        LoggingUtils.getEvoLogger().info("Reinstrumenting for original criterion {}", oldCriterion);
	...
	public static void analyzeCoverage(TestSuiteChromosome testSuite,
		...
		if (goals.isEmpty()) {
            ...
            LoggingUtils.getEvoLogger().info("* Coverage of criterion {}: {}", criterion, NumberFormat.getPercentInstance().format((double) covered
                    / (double) goals.size()));
