...
public class DefUseCoverageFactory extends
	...
	public static void computeGoals() {
        ...
        LoggingUtils.getEvoLogger().info("..created {} intra-method-, {} inter-method- and {} intra-class-pairs", getIntraMethodGoalsCount(), getInterMethodGoalsCount(), getIntraClassGoalsCount());
        ...
        LoggingUtils.getEvoLogger().info(" created {} parameter goals", getParamGoalsCount());
        ...
        LoggingUtils.getEvoLogger().info("* Goal computation took: {}ms", goalComputationTime);
									...
									for (int i = 0; i < traceLength; i++) {
										...
										if (currentDefMap.containsKey(currentDUCounter)) {
											...
											DefUseCoverageTestFitness currentGoal = DefUseCoverageFactory.retrieveGoal(activeDef,
											                                                                           currentUse);
											if (currentGoal == null) {
                                                logger.info("New alias found: Variable defined as {} appeared in use as {}", otherGoalVariable, goalVariable);
												...
												for (DefUseCoverageTestFitness defUse : duGoals) {
													...
													if (defUse.getGoalUse().equals(use)) {
														...
														for (Use otherUse : defUseMap.keySet()) {
															...
															if (goal != null) {
                                                                logger.info("Created new defuse pair: {} of type {}", goal, goal.getType());
