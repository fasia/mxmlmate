...
public class DefUseCoverageSuiteFitness extends TestSuiteFitnessFunction {
	...
	public double getFitnessAlternative(
		...
		for (DefUseCoverageTestFitness goal : goals) {
			...
			if (coveringTests.isEmpty()) {
                ...
                logger.debug("Checking {} tests covering {}", coveringTests.size(), goal);
	...
	public static void printCoverage() {
        ...
        LoggingUtils.getEvoLogger().info("* Time spent optimizing covered goals analysis: {}ms", DefUseExecutionTraceAnalyzer.timeGetCoveredGoals);
        ...
        LoggingUtils.getEvoLogger().info("* Covered {}/{} goals", countMostCoveredGoals(), countGoalsIn(totalGoals));
	}
