...
public class StrongMutationSuiteFitness extends MutationSuiteFitness implements
	...
	public double getFitness(
		...
		*/
		...
		for (TestChromosome test : executionOrder) {
            ...
            logger.debug("Tests touched {} mutants", touchedMutants.size());
	...
	private void updateGoals() {
        ...
        logger.debug("Finished updating goal set. New size: {}, mutants replaced: {}, mutants left: {}", currentGoals.size(), numChanged, remainingGoals.size());
	}
