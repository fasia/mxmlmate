...
public abstract class GenericAccessibleObject<T extends GenericAccessibleObject<?>>
	...
	public T getGenericInstantiation() throws ConstructionFailedException {
        ...
        logger.debug("Getting random generic instantiation of method: {} with owner type map: {}", toString(), typeMap);
		...
		for (TypeVariable<?> parameter : getTypeParameters()) {
            ...
            logger.debug("Setting parameter {} to type {}", parameter, concreteType.getTypeName());
	...
	public T getGenericInstantiation(GenericClass calleeType)
        ...
        logger.debug("Getting generic instantiation for callee {} of method: {} for callee {}", calleeType, toString(), calleeType);
		...
		for (TypeVariable<?> parameter : getTypeParameters()) {
            ...
            logger.debug("(I) Setting parameter {} to type {}", parameter, concreteType.getTypeName());
	...
	public T getGenericInstantiationFromReturnValue(GenericClass generatedType)
        ...
        logger.debug("Getting generic instantiation for return type {} of method: {}", generatedType, toString());
