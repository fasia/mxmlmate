...
public class ListParameters {
	...
	public static Object execute(){
        ...
        LoggingUtils.getEvoLogger().info("{}{}{}{}{}{}{}{}{}{}", name, getGap(name, maxName), space, type, getGap(type, maxType), space, defaultValue, getGap(defaultValue, maxDefault), space, description);

		for(Row row : rows){
            LoggingUtils.getEvoLogger().info("{}{}{}{}{}{}{}{}{}{}", row.name, getGap(row.name, maxName), space, row.type, getGap(row.type, maxType), space, row.defaultValue, getGap(row.defaultValue, maxDefault), space, row.description);
		}
