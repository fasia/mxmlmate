...
public class EvoSuite {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            logger.error("Fatal crash on main EvoSuite process. Class {} using seed {}. Configuration id : {}", Properties.TARGET_CLASS, Randomness.getSeed(), Properties.CONFIGURATION_ID, t);
			System.exit(-1);
		}
