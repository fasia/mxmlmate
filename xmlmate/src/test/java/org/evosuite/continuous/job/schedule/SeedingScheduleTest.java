...
public class SeedingScheduleTest {
	...
	public void testSortingOneDependency(){
		Set<String> dep1 = new HashSet<String>(Collections.singletonList("e"));
	...
	public void testSortingPostponedDependencies(){
		Set<String> dep1 = new HashSet<String>(Collections.singletonList("b"));
		Set<String> dep2 = new HashSet<String>(Collections.singletonList("c"));
